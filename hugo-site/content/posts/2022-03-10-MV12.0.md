...
<img src="https://img.wenbo.space/20220310094040.png" style="zoom:67%;" />

示例：图像分类

![](https://img.wenbo.space/20220310094246.png)
...
![](https://img.wenbo.space/20220310094519.png)

![](https://img.wenbo.space/20220310094543.png)

![](https://img.wenbo.space/20220310094646.png)

许多感知器的分层排列：

![](https://img.wenbo.space/20220310094857.png)
...
![](https://img.wenbo.space/20220310095152.png)
...
![](https://img.wenbo.space/20220310095811.png)
...
![](https://img.wenbo.space/20220310102320.png)
...
![](https://img.wenbo.space/20220310102549.png)
...
1. 训练具有单个隐藏层的自动编码器
   ...
   ![](https://img.wenbo.space/20220310103140.png)

   ![](https://img.wenbo.space/20220310103247.png)

2. 通过附加隐藏层扩展自动编码器

   ![](https://img.wenbo.space/20220310103315.png)

   ![](https://img.wenbo.space/20220310103412.png)
...
<img src="https://img.wenbo.space/20220310103608.png" style="zoom:67%;" />
...
![](https://img.wenbo.space/20220310103920.png)
...
<img src="https://img.wenbo.space/20220310104631.png"  />
...
![](https://img.wenbo.space/20220310104849.png)

### 多通道特征层Multi-Channel Feature Layers  

在每个隐藏层中，想为每个像素计算几个不同的特征 → <u>多通道层</u>

![](https://img.wenbo.space/20220310105353.png)
...
![](https://img.wenbo.space/20220310110253.png)

池化通常与降低层的分辨率相结合

![](https://img.wenbo.space/20220310110357.png)
...
![](https://img.wenbo.space/20220310110454.png)
...
![](https://img.wenbo.space/20220310110646.png)

从层到层... – 特征在几何上变得越来越复杂 – 特征变得越来越独立于位置 – 特征变得越来越独立于图案大小 – 特征变得越来越具体

### ResNet层 ResNet Layers  

![](https://img.wenbo.space/20220310110832.png)