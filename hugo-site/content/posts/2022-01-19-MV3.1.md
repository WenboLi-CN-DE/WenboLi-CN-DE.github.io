...
![img](https://img.wenbo.space/Snipaste_2022-01-19_16-48-09.png)
...
4. 近似导数可以实现为带滤波器掩码的卷积
   ...
   ![](https://img.wenbo.space/20220119173327.png)

## Prewitt算子，Sobel算子

Prewitt算子： 利用像素点上下，左右邻点的灰度差，在边缘处达到极值边缘检测

![](https://img.wenbo.space/20220119173746.png)

Sobel算子：与Prewitt算子相比，Sobel对像素的位置的影响做了加权，可以降低位置的影响

![](https://img.wenbo.space/20220119173847.png)
...
![]()![](https://img.wenbo.space/20220119175209.png)
...
![](https://img.wenbo.space/20220119180210.png)
...
<img src= "https://img.wenbo.space/20220119180804.png" height="330">
...
![](https://img.wenbo.space/20220119181824.png)
...
![](https://img.wenbo.space/20220119182303.png)
